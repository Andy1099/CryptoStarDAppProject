...
contract StarNotary is ERC721 {
    ...
    //Updated the code since the _transferFrom would not work
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerAddress1 || msg.sender == ownerAddress2, "You do not have or own any tokens");
        //4. Use _transferFrom function to exchange the tokens.
        //The instructions ask me to use _transferFrom, but the ERC721 interface has transferFrom
        if (sender == ownerAddress1){
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerAddress, "Sender must own or have a star to be able to transfer");
